                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            _buildIconBtn(
                              ...
                              iconOverrideColor: widget.isDarkMode
                                  ? Colors.amber
                                  : null,
                            ),
  ...
  Widget _buildHelp() {
    return Column(
      ...
      children: [
        ...
        _buildHelpRow(
          'Spawn Chroma Tile',
          'Double-tap workspace background',
          false,
        ),
        ...
        _buildHelpRow(
          'Sink Note to Canvas',
          'Hold 400ms or click Minimize icon',
          true,
        ),
        _buildHelpRow(
          'Restore Sunken Note',
          'Click the floating micro-card',
          false,
        ),
      ],
    );
